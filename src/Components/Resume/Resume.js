...
class Resume extends React.Component {
    render(){
        ...
        return (
            <div className='bkimg'>
                <article className="center pa3 pa4-ns b-none intro-card">
                    <div className="tc dib">
                        <img src={resumePhoto} className="br-100 dib" width='400rem' height='400rem' title="Resume photo" alt=''/>
                    </div>
                    <div className='tc ma3 mt5 black'>
                        ...
                        <a className="f5 link dim ba bw1 ph3 pv2 ma2 dib red pointer" href='https://dl.orangedox.com/xIXv85' target="_blank" rel="noopener noreferrer">Resume</a>
                        <div className='contact'>
                            <div>
                                ...
                                <a className="black ml1 mr4 hover-light-red" href="tel:+91 7987483842" target="_blank" rel="noopener noreferrer">+91 7987483842</a>
                            </div>
                            <div>
            ...
            <section className="tc b-none">
                    ...
                    <ProjectCardLive
                        ...
                        onRouteChange="/restaurantReviews"
